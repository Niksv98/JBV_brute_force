...
rSupport for regular expressions (RE).
...
The special characters are
    ...
    ((idname)yesno) Matches yes pattern if the group with idname matched,
...
def template(pattern, flags=0)
    ...
    return _compile(pattern, flagsT)
...
_special_chars_map = {i '' + chr(i) for i in b'()[]{}+-^$.&~# tnrvf'}
...
def _subx(pattern, template)
    # internal Pattern.subsubn implementation helper
